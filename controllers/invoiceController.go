...
func CreateInvoice() gin.HandlerFunc{
	return func (c *gin.Context){
		...
		invoice.Cteated_at, _ = time.Parse(time.RFC3339,time.Now().Format(time.RFC3339))
		...
		result,inserErr := invoiceCollection.InsertOne(ctx,invoice)
		if inserErr != nil {
